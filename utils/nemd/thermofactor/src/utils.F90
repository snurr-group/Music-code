...
!-----------------------------------------------------------
  ...
  !----------------------------------------------------------------------------
  !  This subroutine returns a linear interpolation
  !----------------------------------------------------------------------------
  Real(Kind=RDbl) Function interpolate(x,y,newx)
    Real(Kind=RDbl), Dimension(2),Intent(In) :: x,y    
    Real(Kind=RDbl), Intent(In) :: newx
    interpolate=y(1) + ( (y(2)-y(1))/(x(2)-x(1)) )*(newx-x(1))
